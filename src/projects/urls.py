...
from projects.views import ProjectDetailView, ReportsView, SubscriptionsView, IntegrationsView, IntegrationCreateView, IntegrationUpdateView
...
urlpatterns = [
    ...
    path("projects/<name>/integrations/<integration>", IntegrationUpdateView.as_view(), name="edit_integration"),
